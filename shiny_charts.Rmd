...
This won't run until we add a website with something like this syntax in the site_yml, but I made a dummy website to test some of it:
  ...
  right:
    ...
    - text: "Paid Leave Maps"
      href: shiny_maps.html
...
This piece doesn't work yet - just included to see the general format
...
charts_df %>% 
  ...
  plot_ly(
    x = ~neighborhood, y = ~mean_leave_weeks, color = ~neighborhood,
